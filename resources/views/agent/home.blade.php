                ...
                <div class="card-body">
                        ...
                        <tr style="font-size:13px;"> 
                            ...
                            <td style="width:100px">
                                <form action"" method="POST">
                                    <a class="btn btn-info" style="font-size:12px;" href="{{route('agent_showitinerary',$itinerary->id)}}">Details</a>
                                </form>
                            </td>
                        </tr>
                        @endforeach
                    ...
                    <table class='table table-striped table-bordered'>
                        ...
                        <tr style="font-size:13px;"> 
                            ...
                            <td style="width:100px">
                                <form action"" method="POST">
                                    <a class="btn btn-info" style="font-size:12px;" href="{{route('agent_showaccomplishment',$accomplishment->id)}}">Details</a>
                                </form>
                            </td>
                        </tr>
                        @endforeach

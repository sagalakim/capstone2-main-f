        ...
        <!-- Sidebar starts here -->
            <div class="bg-white border border-right-0" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush my-3">
                    <a href="{{ url('/home') }}" class="list-group-item list-group-item-action bg-transparent primary-text fw-bold">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item second-text fw-bold" href="{{ url('/sa/liquidations') }}"> <i class="fas fa-folder me-2"></i> Liquidation</a>
                    </div>
                    </div>
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item second-text fw-bold" href="{{ url('/sa/create/liquidation') }}"> <i class="fas fa-clipboard-check me-2"></i> Liquidation</a>
                    </div>
                    </div>

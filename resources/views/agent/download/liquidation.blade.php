...
<head>
    ...
    <title>Liquidation Details Preview</title>
...
<body>
        ...
        <thead>
            <tr>
                <th width="50%" colspan="2" class="company-data">
                    ...
                    <span style="font-size:15px;">Employee name : {{Auth::user()->firstname}} {{Auth::user()->lastname}}</span> <br>
                    <span style="font-size:15px;">Position : {{Auth::user()->role}}</span> <br>
                </th>
    ...
    <p>Liquidated by:</p>
    <p style="text-decoration: underline; margin-top:30px;">{{Auth::user()->firstname}} {{Auth::user()->lastname}}</p>

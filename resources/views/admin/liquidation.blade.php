    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card border-primary" style="border-width:2px; width:1020px; margin-left:-180px;">
                ...
                @endif
                <form action="{{route('adminliquidationstore')}}" method="Post" enctype="multipart/form-data"> 
                    @csrf
                    <div class="row">
                    <input type="text" name='user_id' style="display:none;" value="{{Auth::user()->id}}">
                        ...
                        <div class="col-md-10">
                            <div class="input-group mb-2">
                                ...
                                <input type='date' min="{{ date('Y-m-d') }}" name="date_filed" class="form-control" placholder="Enter Municipality">
                            </div>
                        </div>
                        ...
                        <div class="col-md-10">
                            <div class="input-group">
                                ...
                                <input type='date' min="{{ date('Y-m-d') }}" name="inclusive_date" class="form-control" placholder="Enter Municipality">
                            </div>
                        </div>
                        </div>
                        ...
                        <div class="form-group col-x1-12 col-lg-12 col-md-12 col-sm-12 col-12 child-repeater-table">
                            ...
                            <tbody>
                                <tr>
                                    <td><input type='date' style="width:150px;" min="{{ date('Y-m-d') }}" name="date[]" class="form-control" placholder=""></td>
                        ...
                        <div class="col-md-10">
                            <div class="input-group mb-2">
                                ...
                                <input type='text' name="total" class="form-control locked" value="₱  ---   " placeholder="Enter Municipality">
                            </div>
                        </div>
                        <div class="col-md-10">
                            <div class="input-group mb-2">

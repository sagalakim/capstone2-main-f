...
<body>
    ...
    <div class="col">
    <p>Prepared by:</p>
    <p style="text-decoration: underline; margin-top:-5px;">{{$accomplishment->owner->firstname}} {{$accomplishment->owner->lastname}}</p>
    @if ($accomplishment->owner->role == 'agents')
    <p style="margin-top:-16px; font-size:13px;">Sales Agent</p>
    @elseif($accomplishment->owner->role == 'nsmnl')

        ...
        <div class="col-md-20">
            <div class="card border-primary" style="border-width:2px; height:535px;">
                ...
                <div class="card-body">
                    ...
                    <a class="btn" style="margin-left:750px; color: white; background-color:gray; width:210px;font-size:14px;"><i class="fas fa-lock me-2"></i>Create Accomplishment</a>
                    @else
                    <a href="{{route('adminconfirmAccomplishment',$itinerary->id)}}" class="btn btn-success btn-sm " style="margin-left:800px;"><i class="fas fa-edit me-2"></i>Create Accomplishment</a>
                    @endif
                    <div class="row">
                ...
                <table class='table table-bordered scrollable-table' style="margin-top:20px;">
                    <tr style="border:2px solid #414ab1;">
                        <th>Date</th>
                        <th style="width:200px;">Name of Coop</th>
                        <th>Municipality</th>
                        <th>Account</th>

                ...
                <div class="row justify-content-center">
                  <div class="col-md-20">
                      <div class="card border-primary" style="border-width:2px; height:520">
                          ...
                          <div class="card-body">
                              <h3> {{$user->firstname}}'s Accomplishment Reports</h3>
                          ...
                          <div class="col-md-8 pb-1" style="margin-left:0px; margin-top:10px;">
                            <form method="GET" action="{{route('adminfilter2',$user->id)}}">
                              ...
                              <table class="table table-responsive-sm table-bordered scrollable-table">
                                ...
                                @if ($accomplishment->count()>0)
                                    ...
                                    <tr> 
                                        ...
                                        <td style="width:100px">{{$accomplishment->status}}</td>
                                        @if ($accomplishment->approved_by !== null)
                                        <td style="width:300px">{{$accomplishment->approver->firstname}}</td>
                                        @else
                                        <td></td>
                                        @endif
                                        <td style="width:300px">{{$accomplishment->approver_role}}</td>
                                        <td style="width:300px">
                                            <form action"" method="POST">
                                                <a class="btn btn-info" href="{{route('admin_agent_showaccomplishmentdetails',$accomplishment->id)}}">Details</a>
                                            </form>
                                        </td>
                                    </tr>
                                    @endforeach

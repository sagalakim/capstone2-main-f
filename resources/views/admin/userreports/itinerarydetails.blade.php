            ...
            <div class="card border-primary" style="border-width:2px; height:535px;">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <a class="btn btn-success" style="width:40px; height:35px;margin-right:20px; margin-top:25px; margin-left:550px;" href="{{route('adminapprove',$itinerary->id)}}"><i class="fas fa-check me-2"></i></a>
                        <a class="btn btn-danger" style="width:40px;height:35px; margin-top:25px;" href="{{route('admindisapprove',$itinerary->id)}}"><i class="fas fa-x me-2"></i></a>

        ...
        <div class="col-md-20">
            <div class="card border-primary" style="border-width:2px; height:535px;">
                ...
                <div class="card-body">
                    ...
                    <a href="{{route('adminmydownloadaccomplishment',$accomplishment->id)}}" class="btn btn-success btn-sm " style="margin-left:650px; width:150px;margin-top:-40px;height:30px;"><i class="fas fa-download me-2"></i>Download as PDF</a>
                    <a href="{{route('adminmyadownloadpreview',$accomplishment->id)}}" target="_blank" class="btn btn-warning btn-sm mx-1" style="width:150px; margin-top:-40px;height:30px;"><i class="fas fa-eye me-2"></i>Preview as file</a>
                    ...
                    <div class="row" style="margin-top:-30px;">
                        ...
                        <div class="input-group mb-2" style="margin-top:20px; width:200px; margin-left:0px;">
                            <span class="input-group-text fw-bold">Status: </span>
                            <input type='text'  name="date_filed" class="form-control locked" value="---">
                        </div>
                        @endif
                    </div>
                <form method="POST" action="{{route('admin_save')}}" enctype="multipart/form-data">
                    @csrf

<!-- Modal -->
<div class="modal fade" id="adminitineraryCreateModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
 <div class="modal-dialog modal-dialog-wide">
    ...
    <div class="container-fluid">
      <form id="adminitineraryForm" action="{{route('adminstore')}}" method="Post" enctype="multipart/form-data"> 
                    @csrf
                    <div class="row">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" id="adminsubmitForm" class="btn btn-primary">Submit</button>
      </div>
    </div>
 </div>
</div>
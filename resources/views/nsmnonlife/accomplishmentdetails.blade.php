        ...
        <div class="col-md-20">
            <div class="card border-primary" style="border-width:2px; height:535px;">
                ...
                <div class="card-body">
                    ...
                    <a href="{{route('nsmmydownloadaccomplishment',$accomplishment->id)}}" class="btn btn-success btn-sm " style="margin-left:650px; width:150px;margin-top:-40px;height:30px;"><i class="fas fa-download me-2"></i>Download as PDF</a>
                    <a href="{{route('nsmmyadownloadpreview',$accomplishment->id)}}" target="_blank" class="btn btn-warning btn-sm mx-1" style="width:150px; margin-top:-40px;height:30px;"><i class="fas fa-eye me-2"></i>Preview as file</a>
                    @else
                    <a class="btn btn-default btn-sm" style="margin-left:730px; width:200px; margin-top:-38px; height:30px;"><i class="fas fa-edit me-2"></i>Waiting for Approval</a>
                    @endif
                    ...
                    <div class="row" style="margin-top:-30px;">
                        ...
                        @if ($accomplishment->status === 'Approved')
                        <div class="input-group mb-2" style="margin-top:20px; width:300px; margin-left:0px;">
                ...
                <form method="POST" action="{{route('nsmnl_save')}}" enctype="multipart/form-data">
                    @csrf

        ...
        <div class="col-md-20">
            <div class="card border-primary" style="border-width:2px; height:535px;">
                ...
                <div class="card-body">
                    ...
                    <a href="{{route('nsmconfirmAccomplishment',$itinerary->id)}}" class="btn btn-success btn-sm " style="margin-left:800px;"><i class="fas fa-edit me-2"></i>Create Accomplishment</a>
                    @else

        ...
        <div class="col-md-8">
            <div class="card border-primary" style="border-width:2px; width:1020px; margin-left:-180px;">
                ...
                <div class="card-body">
                    ...
                    <a href="{{route('nsmdownloadliquidation',$liquidation->id)}}" class="btn btn-success btn-sm " style="margin-left:650px;"><i class="fas fa-download me-2"></i>Download liquidation</a>
                    <a href="{{route('nsmdownloadpreview',$liquidation->id)}}" target="_blank" class="btn btn-warning btn-sm mx-1"><i class="fas fa-eye me-2"></i>Preview as file</a>
                    ...
                    <input type="text" name='user_id' style="display:none;" value="{{Auth::user()->id}}">
                        ...
                        <div class="col-md-10">
                            <div class="input-group">
                                ...
                                <a class="form-control" href="{{ route('nsmnlreceipt', $liquidation->id) }}" target="_blank" style="height:40px;"> View receipts</a>
                            </div>
                        </div>
                        </div>
                    </div>

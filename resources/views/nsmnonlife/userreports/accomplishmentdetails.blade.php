            ...
            <div class="card border-primary" style="border-width:2px; height:535px;">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <a class="btn btn-primary" style="width:40px; height:35px;margin-right:20px; margin-top:25px; margin-left:550px;" href="{{route('approve2',$accomplishment->id)}}"><i class="fas fa-check me-2"></i></a>
                        <a class="btn btn-danger" style="width:40px;height:35px; margin-top:25px;" href="{{route('disapprove2',$accomplishment->id)}}"><i class="fas fa-x me-2"></i></a>
                        ...
                        <a href="{{route('nsmdownloadaccomplishment',$accomplishment->id)}}" class="btn btn-success btn-sm " style="margin-left:20px; width:150px;margin-top:-40px;height:30px;"><i class="fas fa-download me-2"></i>Download as PDF</a>
                        <a href="{{route('nsmadownloadpreview',$accomplishment->id)}}" target="_blank" class="btn btn-warning btn-sm mx-1" style="width:150px; margin-top:-40px;height:30px;"><i class="fas fa-eye me-2"></i>Preview as file</a>
                        @else

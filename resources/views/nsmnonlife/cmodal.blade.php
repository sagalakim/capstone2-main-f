<!-- Modal -->
<div class="modal fade" id="itineraryCreateModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
 <div class="modal-dialog modal-dialog-wide">
    ...
    <div class="container-fluid">
      <form id="itineraryForm" action="{{route('store')}}" method="Post" enctype="multipart/form-data"> 
                    @csrf
                    <div class="row">
